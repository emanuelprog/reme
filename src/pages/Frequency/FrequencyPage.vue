<template>
    <q-page class="q-pa-md" :class="$q.dark.isActive ? 'bg-grey-10' : 'bg-white'">
        <div class="column items-center">
            <div class="row justify-start full-width q-mb-sm">
                <q-btn label="Voltar" icon="arrow_back" to="/selection-frequency" flat
                    :color="$q.dark.isActive ? 'white' : 'primary'" dense class="q-ml-sm" />
            </div>
            ...
            <div class="row justify-center q-gutter-sm q-mb-md items-center">
                <q-input v-model="dateRangeText" label="Filtrar por período" outlined dense readonly
                    style="width: 300px">
                ...
                <q-btn label="Limpar filtro" color="warning" dense @click="onClearDateFilter" />
            </div>
                            ...
                            <q-tr :props="props" :class="props.row.hasOccurrence ? 'bg-red-2 text-red-10' : ''">
                                <q-td v-for="col in props.cols" :key="col.name" :props="props"
                                    ...
                                    <template v-else-if="col.name === 'observation'">
                                        <q-btn flat round dense icon="chat_bubble" color="primary"
